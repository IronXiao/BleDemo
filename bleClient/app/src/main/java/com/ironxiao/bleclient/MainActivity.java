...
public class MainActivity extends AppCompatActivity {
    ...
    private ScanResult scanResultToConnect = null;
    ...
    static {
        scanFilters.add(new ScanFilter.Builder().setServiceUuid(new ParcelUuid(UUID_SETUP)).setManufacturerData(MANUFACTURE_ID, MANUFACTURE.getBytes()).build());
    }
